# -*- coding: utf-8 -*-
"""Basic Model (new learning rate & Epochs + friendlu loss & conf matrix graphs) + Augmentation.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1P9lqKV8ZdkHFcAOJZJ69PtG7tPeIwf3i
"""
...
size = 224
dataset = []
my_images = os.listdir(glaucoma_images_path)
for i, image_name in enumerate(my_images):
    if (image_name.split('.')[1] == 'jpg'):
        image = io.imread(glaucoma_images_path + '/' + image_name)
...
model.compile(loss="binary_crossentropy", optimizer=Adam(learning_rate=0.00001), metrics=['accuracy', 'mse'])
...
# Create model and compile with Adam optimizer and binary cross-entropy loss
model = Model(inputs=resnet_model.input, outputs=predictions)
...
model.save("model2_glaucoma_augmentation.keras")
